...
{% include base_path %}
<a href="/main.pdf" download><strong>Download CV (PDF)</strong></a>
...
Hu H, **Feng L**, Chen S, Zheng T, Jiang D, Chen W, Zhang C, Yang G, and Jin Y. "QuietWalk: Physics-Informed Reinforcement Learning for Ground Reaction Force-Aware Humanoid Locomotion Under Diverse Footwear", https://arxiv.org/abs/2604.23702

### 2026
Azam H, Xu W, **Feng L**, et al. Subject-independent hip moment estimation from bilateral hip angles in transitional and steady-state gait[J]. Expert Systems with Applications, 2026: 132047.
...
Chen W, Jin Y, **Feng L**, Pan W. X. An embodied intelligent robot inspired by biological development and its control method[P]. CN121849266A, 2026-04-14.

Jin Y, **Feng L**, Chen W. A robot agent evaluation system for lower-limb exoskeletons and a gait policy training method for the corresponding agent[P]. CN121777198A, 2026-04-03.
